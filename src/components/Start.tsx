                ...
                <List>
                    ...
                    <ListItem key={1} disablePadding sx={{display: 'block'}}>
                        ...
                        >
                            ...
                            <ListItemText primary={'Пациент'} sx={{opacity: open ? 1 : 0}}/>
                        </ListItemButton>
                    </ListItem>
                    ...
                    <ListItem key={2} disablePadding sx={{display: 'block'}}>
                        ...
                        >
                            ...
                            <ListItemText primary={'План лечения'} sx={{opacity: open ? 1 : 0}}/>
                        </ListItemButton>
                    </ListItem>
                    ...
                    <ListItem key={3} disablePadding sx={{display: 'block'}}>
                        ...
                        >
                            ...
                            <ListItemText primary={'Диагностические'} sx={{opacity: open ? 1 : 0}}/>
                        </ListItemButton>
                    </ListItem>
                    ...
                    <ListItem key={4} disablePadding sx={{display: 'block'}}>
                        ...
                        >
                            ...
                            <ListItemText primary={'Отчет'} sx={{opacity: open ? 1 : 0}}/>
                        </ListItemButton>
                    </ListItem>
